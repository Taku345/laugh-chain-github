...
const VoteButton = ({ district, candidate, initialRate = 0 }) => {
    ...
    return (
        <>
            ...
            {(auth.account &&
                district.progress ==
                    laugh_chain_config.district.progress.voting && (
                    <>
                        <button
                        ...
                        >
                            ...
                            <span
                                className={`${
                                    rate > 0 ? "text-xl text-orange-200" : ""
                                } `}
                            >
                                {rate}
                            </span>
                ...
                <>
                    <button className="rounded bg-rose-600 text-white px-4 py-2">
                        終了！「
                        <span
                            className={`${
                                rate > 0 ? "text-xl text-orange-200" : ""
        ...
        <>
            ...
            <ul className="text-sm flex flex-wrap">
                {district.candidate.map((candidate) => (
                    <div className=" border rounded p-4 px-6 my-2 ml-1">
                        <VoteButton
                            district={district}
                            candidate={candidate}
                            initialRate={
